...
// based upon the OTA WiFiSettings example:
// https://github.com/Juerd/ESP-WiFiSettings/blob/master/examples/ArduinoOTA/ArduinoOTA.ino
//
#include <SPIFFS.h>
...
void setup_wifi() {
    ...
    // Because OTA is remote code execution (RCE) by definition, the password should be kept secret. By default, WiFiSettings will become
    // an insecure WiFi access point and happily tell anyone the password. The password
